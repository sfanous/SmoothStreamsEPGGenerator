...
class Utility(object):
        ...
        for xmltv_file_name in os.listdir(output_directory_path):
            if xmltv_file_name.endswith('.xml'):
                xmltv_file_attributes = os.stat(
                    os.path.join(output_directory_path, xmltv_file_name)
                )
                ...
                if (
                    latest_file_modification_date_time_in_local is None
                    or xmltv_file_modification_date_time_in_local
                    > latest_file_modification_date_time_in_local
                ):
                    latest_file_modification_date_time_in_local = (
                        xmltv_file_modification_date_time_in_local
                    )
    ...
    def parse_command_line_arguments(cls):
        ...
        return (
            arguments.do_backup_output_xmltv_files,
