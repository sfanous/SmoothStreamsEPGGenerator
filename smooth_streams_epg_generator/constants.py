...
DEFAULT_CHANNEL_MAP_DIRECTORY_PATH = os.path.join(
    sys.path[0], 'resources', 'channel_map'
)
DEFAULT_CHANNEL_MAP_FILE_PATH = os.path.join(
    DEFAULT_CHANNEL_MAP_DIRECTORY_PATH, 'smooth_streams.xml'
)
DEFAULT_CONFIGURATION_FILE_PATH = os.path.join(
    sys.path[0], 'smooth_streams_epg_generator.ini'
)
DEFAULT_DB_DIRECTORY_PATH = os.path.join(sys.path[0], 'db')
DEFAULT_DB_FILE_PATH = os.path.join(
    DEFAULT_DB_DIRECTORY_PATH, 'smooth_streams_epg_generator.db'
)
DEFAULT_DB_CREATE_SCHEMA_FILE_PATH = os.path.join(
    DEFAULT_DB_DIRECTORY_PATH, 'create_schema.sql'
)
DEFAULT_GMAIL_ENABLED = True
...
DEFAULT_LOG_FILE_PATH = os.path.join(
    DEFAULT_LOG_DIRECTORY_PATH, 'smooth_streams_epg_generator.log'
)
DEFAULT_MC2XML_DIRECTORY_PATH = os.path.join(sys.path[0], 'mc2xml')
DEFAULT_MC2XML_EXECUTABLE_MAP = {
    'Darwin': 'mc2xml_osx.bin',
...
DEFAULT_ROVI_TEMPLATE_FILE_PATH = os.path.join(
    DEFAULT_MC2XML_DIRECTORY_PATH, 'rovi_template', 'templates.json'
)
DEFAULT_ROVI_TEMPLATE_URL = 'http://cloud.rovicorp.com/template/v1/{0}/3/templates.json'
